...
class show_canteen_class:
	...
	def draw(self):
		...
		for i in range(len(self.list_canteen_sorted)):
			if i == 0:
		...
		if self.canteen_1 != []:
			...
			self.message_display(str(self.canteen_1[0]['Distance']), (800, 213))
			self.message_display(str(self.canteen_1[0]['Price']), (1035, 213))
			star.star(canteen_1_list, self.canteen_1[0]['Rating']).show_rate(self.image)
		if self.canteen_2 != []:
			self.image.blit(self.house, (340, 270))
			self.message_display(self.canteen_2[0]['Canteen'], (550, 313))
			self.message_display(str(self.canteen_2[0]['Distance']), (800, 313))
			self.message_display(str(self.canteen_2[0]['Price']), (1035, 313))
			star.star(canteen_2_list, self.canteen_2[0]['Rating']).show_rate(self.image)
		if self.canteen_3 != []:
			self.image.blit(self.house, (340, 370))
			self.message_display(self.canteen_3[0]['Canteen'], (550, 413))
			self.message_display(str(self.canteen_3[0]['Distance']), (800, 413))
			self.message_display(str(self.canteen_3[0]['Price']), (1035, 413))
			star.star(canteen_3_list, self.canteen_3[0]['Rating']).show_rate(self.image)
		if self.canteen_4 != []:
			self.image.blit(house, (340, 470))
			self.message_display(self.canteen_4[0]['Canteen'], (550, 513))
			self.message_display(str(self.canteen_4[0]['Distance']), (800, 513))
			self.message_display(str(self.canteen_4[0]['Price']), (1035, 513))
			star.star(canteen_4_list, self.canteen_4[0]['Rating']).show_rate(self.image)
		if self.canteen_5 != []:
			self.image.blit(self.house, (340, 570))
			self.message_display(self.canteen_5[0]['Canteen'], (550, 613))
			self.message_display(str(self.canteen_5[0]['Distance']), (800, 613))
			self.message_display(str(self.canteen_5[0]['Price']), (1035, 613))
			star.star(canteen_5_list, self.canteen_5[0]['Rating']).show_rate(self.image)		
...
def new_text_objects(text, font, color, text_rect_center):
    textSurface = font.render(text, True, color)
